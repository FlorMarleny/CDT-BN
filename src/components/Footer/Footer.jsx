        ...
        <div className="row">
          ...
          <div className="d-flex col-md-9 col-sm-12">
            ...
            <div className="col-md-3 col-sm-6 col-6 p-0 mb-3 float-left">
              ...
              <ul className="list-group">
                <li className="list-group-item bg-transparent border-0 p-0 mb-2"><a className="a" href="https://github.com/naologic">Open Source</a></li>
                <li className="list-group-item bg-transparent border-0 p-0 mb-2"><a className="a" href="https://stackshare.io/naologic">Technology</a></li>
              </ul>
            </div>
            ...
            <div className="col-md-3 col-sm-6 col-6 mb-3 p-0 float-left">
              ...
              <ul className="list-group">
                <li className="list-group-item bg-transparent border-0 p-0 mb-2"><a className="a" href="../about-naologic.html">About</a></li>
                <li className="list-group-item bg-transparent border-0 p-0 mb-2"><a className="a" href="https://blog.naologic.com">Blog</a></li>
              </ul>
            </div>
