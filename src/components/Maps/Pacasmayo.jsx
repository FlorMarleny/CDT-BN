...
const Sechura = () => {
  useEffect(() => {
    ...
    const map = L.map('pacasmayo-map', {
      center: [-7.429782008614252, -79.50379459706751],
      zoom: 16.5,
    ...
    const marker = L.marker([-7.429782008614252, -79.50379459706751], { icon: customIcon }).addTo(map);

    // Configurar un texto (tooltip) para el marcador
    marker
      .bindTooltip('CDT - Pacasmayo', {
  ...
  return <div id="pacasmayo-map" style={{ height: '200px' }}></div>;
};
